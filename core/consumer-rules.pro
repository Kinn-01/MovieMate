...
-keep class com.example.core.data.dataSource.MovieRepository { *; }
-keep class com.example.core.** { *; }

# Keep Resource classes and their members
-keep class com.example.core.data.dataSource.Resource$Error { *; }
-keep class com.example.core.data.dataSource.Resource$Loading { *; }
-keep class com.example.core.data.dataSource.Resource$Success { *; }
-keep class com.example.core.data.dataSource.Resource { *; }

# Keep DataSource classes and their members
-keep class com.example.core.data.dataSource.local.LocalDataSource { *; }
-keep class com.example.core.data.dataSource.remote.RemoteDataSource { *; }
-keep class com.example.core.data.dataSource.remote.retrofit.ApiServices { *; }
-keep class com.example.core.data.dataSource.local.room.MovieDao { *; }
...
-keep class com.example.core.presentation.MovieAdapter { *; }
-keep class com.example.core.presentation.MovieAdapter$OnItemClickCallback { *;}

# Keep utility classes
-keep class com.example.core.utils.AppExecutors { *; }
-keep class com.example.core.utils.DarkMode { *; }
